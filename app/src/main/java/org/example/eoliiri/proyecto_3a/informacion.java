    ...
    private List<Fragment> createFragments(int viewPagerIndex) {
        ...
        switch (viewPagerIndex) {
            ...
            case 2:
                ...
                break;
            case 3:
                fragments.add(new TextFragment("La intoxicación por CO puede causar dolores de cabeza, náuseas, coma e incluso la muerte."));
                fragments.add(new TextFragment("El CO es un gas incoloro e inodoro que se produce al quemar combustibles."));
                fragments.add(new TextFragment("La concentración de CO debe mantenerse a niveles seguros y generalmente no debe superar los 9 miligramos por metro cúbico."));
                fragments.add(new TextFragment("Asegurar el funcionamiento adecuado de dispositivos como calentadores de gas y estufas de carbón, y mantener una buena ventilación."));
                break;
            case 4:
